...
var TypeHelpers = new function(){
    var me = this;
    me.hasSmoothingCached = null;
   
    me.hasSmoothing = function(){
        if (me.hasSmoothingCached != null) {
            return me.hasSmoothingCached;
        }
   
        // IE has screen.fontSmoothingEnabled - sweet!
        smoothing_search:      
        if (typeof(screen.fontSmoothingEnabled) != "undefined") {
            me.hasSmoothingCached = screen.fontSmoothingEnabled;
        } else {
            ...
            try {
                ...
                canvasNode.id = 'fontsmoothing-test';
                canvasNode.width = "35";
                ...
                for (var j = 8; j <= 32; j++) {
                    for (var i = 1; i <= 32; i++) {
                        ...
                        if (alpha != 255 && alpha != 0) {
                            me.hasSmoothingCached = true;
                            //return me.hasSmoothingCached; // font-smoothing must be on.
                            break smoothing_search;
                        }
                    }
        ...
        // unclutter dom...
        if (canvasNode.parentNode) { canvasNode.parentNode.removeChild(canvasNode); }
        return me.hasSmoothingCached;  
    }
...
Modernizr.addTest('fontsmoothing',TypeHelpers.hasSmoothing);
